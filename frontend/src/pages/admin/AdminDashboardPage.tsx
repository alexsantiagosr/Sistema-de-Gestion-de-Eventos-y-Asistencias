...
import { Calendar, Plus, Users, CheckCircle, TrendingUp } from 'lucide-react';
    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-secondary mt-1">Gestiona eventos y visualiza métricas</p>
        </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Link to="/admin/events/new">
                <div className="p-4 bg-primary/10 rounded-xl hover:bg-primary/20 transition-colors cursor-pointer">
                  ...
                  <p className="text-sm text-secondary mt-1">Nuevo evento</p>
                </div>
              </Link>
              <Link to="/admin/events">
                <div className="p-4 bg-green-100 rounded-xl hover:bg-green-200 transition-colors cursor-pointer">
                  <Calendar className="w-8 h-8 text-green-600 mb-2" />
                  <p className="font-medium text-gray-900">Gestionar</p>
                  <p className="text-sm text-secondary mt-1">Todos los eventos</p>
                </div>
              </Link>
              <Link to="/admin/attendances">
                <div className="p-4 bg-purple-100 rounded-xl hover:bg-purple-200 transition-colors cursor-pointer">
                  ...
                  <p className="text-sm text-secondary mt-1">Control QR</p>
                </div>
              </Link>
              <Link to="/admin/users">
                <div className="p-4 bg-orange-100 rounded-xl hover:bg-orange-200 transition-colors cursor-pointer">
                  <Users className="w-8 h-8 text-orange-600 mb-2" />
                  <p className="font-medium text-gray-900">Usuarios</p>
                  <p className="text-sm text-secondary mt-1">Gestionar</p>
                </div>
              </Link>
            </div>
          </CardContent>
